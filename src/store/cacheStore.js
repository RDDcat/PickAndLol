...
export const useCacheStore = defineStore('cacheStore', {
    state: ()=>({
        ...
        isSave:false,
        players:[
            {vp:50, id:0, line:"TOP", name:"Zeus", stat:0, team:"T1", img: "./assets/player/T1_Zeus.svg", 
                killCount:0, deathCount:0, assistCount:0, killRate:0, info:"그는 신인가"},
            {vp:50, id:1, line:"JGL", name:"Oner", stat:0, team:"T1", img: "./assets/player/T1_Oner.svg"},
            {vp:300, id:2, line:"MID", name:"Faker", stat:0, team:"T1", img: "./assets/player/T1_Faker.svg"},
            {vp:150, id:3, line:"ADC", name:"Gumayusi", stat:0, team:"T1", img: "./assets/player/T1_Gumayusi.svg"},
            {vp:100, id:4, line:"SUP", name:"Keria", stat:0, team:"T1", img: "./assets/player/T1_Keria.svg"},
    
            {vp:200, id:5, line:"TOP", name:"Kiin", stat:0, team:"GEN", img: "./assets/player/GEN_Kiin.svg"},
            {vp:280, id:6, line:"JGL", name:"Canyon", stat:0, team:"GEN", img: "./assets/player/GEN_Canyon.svg"},
            {vp:300, id:7, line:"MID", name:"Chovy", stat:0, team:"GEN", img: "./assets/player/GEN_Chovy.svg"},
            {vp:10, id:8, line:"ADC", name:"Peyz", stat:0, team:"GEN", img: "./assets/player/GEN_Peyz.svg"},
            {vp:90, id:9, line:"SUP", name:"Lehends", stat:0, team:"GEN", img: "./assets/player/GEN_Lehends.svg"},
            ...
            {vp:150, id:0, line:"JGL", name:"Peanut", stat:0, team:"HLE", img: "./assets/player/HLE_Peanut.svg"},
            {vp:250, id:0, line:"MID", name:"Zeka", stat:0, team:"HLE", img: "./assets/player/HLE_Zeka.svg"},
            {vp:300, id:0, line:"ADC", name:"Viper", stat:0, team:"HLE", img: "./assets/player/HLE_Viper.svg"},
            ...
            {vp:250, id:0, line:"MID", name:"ShowMaker", stat:0, team:"DK", img: "./assets/player/DK_ShowMaker.svg"},
            ...
            {vp:50, id:0, line:"TOP", name:"Rascal", stat:0, team:"DRX", img: "./assets/player/DRX_Rascal.svg"},
            ...
            {vp:10, id:0, line:"ADC", name:"Teddy", stat:0, team:"DRX", img: "./assets/player/DRX_Teddy.svg"},
            ...
            {vp:15, id:0, line:"MID", name:"BuLLDoG", stat:0, team:"KDF", img: "./assets/player/KDF_BuLLDoG.svg"},
