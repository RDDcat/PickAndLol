        ...
        <div class="w-full flex">
            ...
            <div class="w-full flex flex-col">
                ...
                <div class="relative flex mx-auto">
                    ...
                    <div class="absolute left-6 top-6 bg-white rounded-full bg-opacity-80">
                    ...
                    <div class="absolute left-20 top-24 bg-white rounded-full bg-opacity-80">
                    ...
                    <div class="absolute left-40 top-40 bg-white rounded-full bg-opacity-80">
                    ...
                    <div class="absolute right-24 bottom-20 bg-white rounded-full bg-opacity-80">
                    ...
                    <div class="absolute right-8 bottom-8 bg-white rounded-full bg-opacity-80">
